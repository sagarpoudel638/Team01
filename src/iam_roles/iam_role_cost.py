...
# Function to download and parse CSV file from S3
...
# Function to fetch mapping from Lambda ARNs to IAM Role ARNs
...
# Function to fetch subscriptions for given SNS topics
...
# Function to map IAM role ARNs for given CloudWatch log group ARNs
...
# Function to map costs to IAM roles based on Lambda functions and SNS subscriptions
...
# Function to push mapped costs by IAM roles to Prometheus Pushgateway
...
# Function to send email with role costs using SES
